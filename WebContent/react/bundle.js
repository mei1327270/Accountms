...
/***/ function(module, exports, __webpack_require__) {
	...
	var Account = React.createClass({displayName: "Account",
	    ...
	    getInitialDates:function(){
	        $.ajax({
	            type:"POST",
	            url:"account-showAllAccountInfo",
	            cache:false,
	            success:function(data){
	                if(data !== null && data !== undefined){
	                    ...
	                    this.setState({infoArr:dataS,flag:'1'});
	                }
	            }.bind(this),
	        })

	    },
	    saveAccInfo:function(){
	        $.ajax({
	            type:"POST",
	            data:{
	        ...
	        $.ajax({
	            ...
	            success:function(data){
	                if(data !== null && data !== undefined){
	                    ...
	                    var accNum = object["accNum"];
	                    var accName = object["accName"];
	                    var accState = object["accState"];
	                    var accType = object["accType"];
	                    var remark = object["remark"];
	                    this.setState({accInfo:object,flag:'2',accNum:accNum,accName:accName,accState:accState,accType:accType,remark:remark})
	                }
	            }.bind(this),
	    ...
	    addAccInfoHandle:function(){
	        var accNum = this.state.accNum;
	        ...
	        $.ajax({
	            ...
	            success:function(data){
	                if(data.message !== null && data.message !== undefined && data.message !== "")
	                    alert(data.message);
	                this.setState({added:'',flag:''});
	            }.bind(this),
	        })
	    },
	    deleteAccInfoHandle:function(event){
	        var val = event.target.value;
	        if(confirm("确定要删除吗?")){
	            $.ajax({
	                type:"POST",
	    ...
	    render:function(){
	       if(this.state.flag !== null && this.state.flag !== undefined && this.state.flag === '1'){
	           var infoArr = this.state.infoArr;
	           var arr = new Array();
	           var accArr = new Array();
	           for(var i = 0; i < infoArr.length;i++){
	               var arr_tr = infoArr[i];
	               var arr_td = new Array();
	               for(var item in arr_tr){
	                   arr_td.push(React.createElement("td", {key: item}, arr_tr[item]))
	               }
	               arr_td.push(React.createElement("td", null, React.createElement("button", {value: arr_tr["accNum"], onClick: this.modifyHandle}, "修改"), React.createElement("button", {value: arr_tr["accNum"], onClick: this.deleteAccInfoHandle}, "删除")))
	               arr.push(React.createElement("tr", {key: i}, arr_td));
	               }
	           arr.push(React.createElement("tr", {key: i+1}, React.createElement("td", {colSpan: 8}, React.createElement("button", {style: {width:"50%"}, onClick: this.addAccInfo}, "点击添加"))));

	           if(this.state.added !== null && this.state.added !== undefined && this.state.added ==="1"){
	               var arr_td1 = new Array();
	               arr_td1.push(React.createElement("td", null, "编号", React.createElement("input", {type: "text", onChange: this.changeHandle.bind(this,'accNum')})))
	               arr_td1.push(React.createElement("td", null, "名称", React.createElement("input", {type: "text", onChange: this.changeHandle.bind(this,'accName')})))
	               var arr_td2 = new Array();
	               arr_td2.push(React.createElement("td", null, "状态", React.createElement("input", {type: "text", onChange: this.changeHandle.bind(this,'accState')})))
	               arr_td2.push(React.createElement("td", null, "类型", React.createElement("input", {type: "text", onChange: this.changeHandle.bind(this,'accType')})))
	               var arr_td3 = new Array();
	               arr_td3.push(React.createElement("td", {colSpan: 2}, "备注", React.createElement("input", {type: "text", onChange: this.changeHandle.bind(this,'remark')})))
	               var arr_trS = new Array();
	               var arr_tr1 = new Array();
	               var arr_tr2 = new Array();
	               var arr_tr3 = new Array();
	               arr_tr1.push(React.createElement("tr", null, arr_td1))
	               arr_tr2.push(React.createElement("tr", null, arr_td2))
	               arr_tr3.push(React.createElement("tr", null, arr_td3))
	               arr_trS.push(arr_tr1)
	               arr_trS.push(arr_tr2)
	               arr_trS.push(arr_tr3)
	               arr_trS.push(React.createElement("tr", null, React.createElement("td", {colSpan: 2}, React.createElement("button", {style: {width:"50%"}, onClick: this.addAccInfoHandle}, "添加"))))
	               ...
	               React.createElement("div", null, 
	                    React.createElement("div", null, 
	                       React.createElement("table", {className: "table"}, 
	                           ...
	                           React.createElement("th", null, "编码"), 
	                           React.createElement("th", null, "名称"), 
	                           React.createElement("th", null, "状态"), 
	                           React.createElement("th", null, "账号类型"), 
	       ...
	       }else if(this.state.flag !== null && this.state.flag !== undefined && this.state.flag === '2'){
	           var arr_td1 = new Array();
	           arr_td1.push(React.createElement("td", null, "编号", React.createElement("input", {type: "text", disabled: "true", value: this.state.accNum})))
	           arr_td1.push(React.createElement("td", null, "名称", React.createElement("input", {type: "text", value: this.state.accName, onChange: this.changeHandle.bind(this,'accName')})))
	           var arr_td2 = new Array();
	           arr_td2.push(React.createElement("td", null, "状态", React.createElement("input", {type: "text", value: this.state.accState, onChange: this.changeHandle.bind(this,'accState')})))
	           arr_td2.push(React.createElement("td", null, "类型", React.createElement("input", {type: "text", value: this.state.accType, onChange: this.changeHandle.bind(this,'accType')})))
	           var arr_td3 = new Array();
	           arr_td3.push(React.createElement("td", {colSpan: 2}, "备注", React.createElement("input", {type: "text", value: this.state.remark, onChange: this.changeHandle.bind(this,'remark')})))
	           ...
	           arr_tr.push(arr_tr2)
	           arr_tr.push(arr_tr3)
	           arr_tr.push(React.createElement("tr", null, React.createElement("td", {colSpan: 2}, React.createElement("button", {style: {width:"50%"}, onClick: this.saveAccInfo}, "保存"))))
	return(
	           React.createElement("table", {className: "table"}, 
	               React.createElement("tbody", null, 
	               arr_tr
	...
	ReactDOM.render(React.createElement(Account, null), document.getElementById("accInfo"));
